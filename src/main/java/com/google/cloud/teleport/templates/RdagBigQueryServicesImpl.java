...
public class RdagBigQueryServicesImpl implements BigQueryServices {
  ...
  public JobService getJobService(BigQueryOptions options) {
    return new RdagBigQueryServicesImpl.JobServiceImpl(options);
  }

  @Override
  public DatasetService getDatasetService(BigQueryOptions options) {
    return new RdagBigQueryServicesImpl.DatasetServiceImpl(options);
  }

  @Override
  public StorageClient getStorageClient(BigQueryOptions options) throws IOException {
    return new RdagBigQueryServicesImpl.StorageClientImpl(options);
  }
  ...
  static class DatasetServiceImpl implements DatasetService {
    ...
    <T> long insertAll(
      ...
      if (executor == null) {
        this.executor =
            new RdagBigQueryServicesImpl.BoundedExecutorService(
